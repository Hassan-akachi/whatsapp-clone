...
import 'package:whatsapp_ui/features/call/screen/call_pickup_screen.dart';
...
class MobileChatScreen extends ConsumerWidget {
  ...
  const MobileChatScreen({Key? key, required this.name, required this.uid,required this.profilePic,required this.isGroupChat,})
      : super(key: key);
